...
##### Get Jet to Tau FR
#from Step1_JetToEleFR_Data import Make_Ele_FakeRate
#from Step1_JetToEleFR_Data import *
##### Get Jet to Tau FR
...
SubRootDir = 'OutFiles_DiEle/'
#SubRootDir = 'OutFiles_DiEle_ScaledWZ'
#SubRootDir = 'OutFiles_DiEle_NoZScale/'
...
def MakeTheHistogram(SubRootDir,channel,NormMC,NormQCD,ShapeQCD,NormTTbar):
    ...
    OutFile = TFile(("TotalRoot_DiEle_"+SubRootDir+channel + NormMC+".root").replace('_OutFiles_DiEle','') , 'RECREATE') # Name Of the output file
...
#        
#
#        FR_FitMaram=Make_Ele_FakeRate(channel)
#        QCDEstimation=0
...
#    PlotName=["_tmass_EleMet","_LepEta","_LepPt","_JetPt","_JetEta","_MET","_LQMass","_dPhi_Jet_Met","_dPhi_Ele_Jet","_dPhi_Ele_Met","_NumJet","_NumBJet"]
...
#                            NormQCD="_CloseJetLepPt"+mt+jpt+etalq+reg+"_AntiIso"
                    ...
                    MakeTheHistogram('OutFiles_DiEle',channel,NormMC,NormQCD,ShapeQCD,NormTTbar)
#                    MakeTheHistogram('OutFiles_DiEle_NoZScale',channel,NormMC,NormQCD,ShapeQCD,NormTTbar)
#                    MakeTheHistogram('OutFiles_DiEle_RealDiEle',channel,NormMC,NormQCD,ShapeQCD,NormTTbar)
