...
//    
    ...
    for (int k = 0; k < input.size(); k++) {
        ...
        for (Int_t i = 0; i < nentries_wtn; i++) {
            ...
            TLorentzVector WGEN4Momentum, MUGEN4Momentum, NUGEN4Momentum;
            ...
            for (int igen=0;igen < nMC; igen++){
                ...
                if (fabs(mcPID->at(igen)) ==24   && mcStatus->at(igen) ==22)  {WBosonPt= mcPt->at(igen); WBosonMass=mcMass->at(igen);} // In
                //
            ...
            if (HistoTot){
                ...
                if (isFXFX !=string::npos) {
                    ...
                    LumiWeight = weightCalc(HistoTot, InputROOT,genHT, W_HTBinROOTFiles, WBosonMass, W_MassBinROOTFiles);
