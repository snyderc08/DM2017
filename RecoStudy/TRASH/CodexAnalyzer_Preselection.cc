...
//                float PUMC_=t.HistPUMC(puNUmmc);
//                float PUData_=t.HistPUData(puNUmdata);
                float PUMC_=HistoPUMC->GetBinContent(puNUmmc+1);
                float PUData_=HistoPUData->GetBinContent(puNUmdata+1);
//                cout<<puTrue->at(0)<<"  "<<puNUmmc+1<<"  "<<PUMC_<<"   "<<puNUmdata+1 <<"  "<<PUData_<<"\n";
                if (PUMC_ ==0)
...
//                    cout<<"ElectronEffVeto= "<<ElectronEffVeto<<"\n";
                continue;
                }
...
//                cout<<"getCorrFactorMuon80X "<<MuonCor<<"\n";
