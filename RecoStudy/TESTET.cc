                                                    ...
                                                    if (MetCut_category[jpt]) {
                                                        for (int itopRW = 0; itopRW < size_topPtRW; itopRW++) {
                                                            ...
                                                            if (!( std::find(HistNamesFilled.begin(), HistNamesFilled.end(), FullStringName) != HistNamesFilled.end())){
                                                                ...
                                                                if (isWJets!= string::npos) plotFill(CHL+"_LQMass_ewkKfactor_WUp"+FullStringName,LQ.M(),300,0,3000,FullWeight*WBosonKFactor_ewkUp);
                                                                if (isWJets!= string::npos) plotFill(CHL+"_LQMass_ewkKfactor_WDown"+FullStringName,LQ.M(),300,0,3000,FullWeight*WBosonKFactor_ewkDown);
                                                                if (isDYJets!= string::npos) plotFill(CHL+"_LQMass_ewkKfactor_ZUp"+FullStringName,LQ.M(),300,0,3000,FullWeight*ZBosonKFactor_ewkUp);
                                                                if (isDYJets!= string::npos) plotFill(CHL+"_LQMass_ewkKfactor_ZDown"+FullStringName,LQ.M(),300,0,3000,FullWeight*ZBosonKFactor_ewkDown);
