...
xrdfs root://cmseos.fnal.gov ls "/eos/uscms/store/user/oneogi/Moriond17/SignalPrivate/"$DataSetName | grep $rootNumber.root | while read FullDataSetName
...
do
 ...
 ShortName=${file##*SignalPrivate}  # This removes all the string before Moriond17 (including Moriond17)
