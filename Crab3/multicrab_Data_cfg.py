...
config.Data.outLFNDirBase = '/store/user/csnyder/DM_Electron/Data/'
...
if __name__ == '__main__':
    ...
    # We want to put all the CRAB project directories from the tasks we submit here 
    ...
    config.General.requestName = "SingleElectron_Run2016B-03Feb2017_ver2-v2"
    config.Data.inputDataset = "/SingleElectron/Run2016B-03Feb2017_ver2-v2/MINIAOD"
    submit(config)

    config.General.requestName = "SingleElectron_Run2016C-03Feb2017-v1"
    config.Data.inputDataset = "/SingleElectron/Run2016C-03Feb2017-v1/MINIAOD"
    submit(config)

    config.General.requestName = "SingleElectron_Run2016D-03Feb2017-v1"
    config.Data.inputDataset = "/SingleElectron/Run2016D-03Feb2017-v1/MINIAOD"
    submit(config)

    config.General.requestName = "SingleElectron_Run2016E-03Feb2017-v1"
    config.Data.inputDataset = "/SingleElectron/Run2016E-03Feb2017-v1/MINIAOD"
    submit(config)

    config.General.requestName = "SingleElectron_Run2016F-03Feb2017-v1"
    config.Data.inputDataset = "/SingleElectron/Run2016F-03Feb2017-v1/MINIAOD"
    submit(config)

    config.General.requestName = "SingleElectron_Run2016G-03Feb2017-v1"
    config.Data.inputDataset = "/SingleElectron/Run2016G-03Feb2017-v1/MINIAOD"
    submit(config)

    config.General.requestName = "SingleElectron_Run2016H-03Feb2017_ver2-v1"
    config.Data.inputDataset = "/SingleElectron/Run2016H-03Feb2017_ver2-v1/MINIAOD"
    submit(config)

    config.General.requestName = "SingleElectron_Run2016H-03Feb2017_ver3-v1"
