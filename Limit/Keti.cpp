...
int main() {
    ...
    bkg_procs["mj"] = {"ZTT", "ZL", "TT", "QCD"};
    
    //KK
    //    VString sig_procs = {"Codex_"};
    vector<string> sig_procs = {"ggH"};
...
//    vector<string> masses = ch::MassesFromRange("800-1500:100");
    ...
    for (string era : {"13TeV"}) {
	  ...
	  //KK
	  //            string file = aux_shapes + input_folders[chn] + "/_mj_LQMass_MT500_MET100_Iso.root";
	  string file = aux_shapes + input_folders[chn] + "/tauTau_m_vis_withMTD.root";
...
//    .AddSyst(cb, "CMS_scale_jer", "shape", SystMap<>::init(1.00));
    ...
    */
    ...
    //KK
    //    string folder = "outputCedex_Sep3/LIMITS";
    string folder = "outputHTTVBF_Oct12/LIMITS";
