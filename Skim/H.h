...
// Fri Feb 24 15:23:42 2017 by ROOT version 6.04/14
...
Int_t H::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t H::LoadTree(Long64_t entry)
{
